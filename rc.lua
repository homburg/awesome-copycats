...
function run_once(cmd)
  ...
  awful.util.spawn_with_shell("pgrep -u $USER -x " .. findme .. " > /dev/null; or bash -c " .. cmd)
end
...
function ()
    awful.util.spawn_with_shell("mpc prev;or ncmpcpp prev;or ncmpc prev;or pms prev")
    mpdwidget.update()
end)))
next_icon:buttons(awful.util.table.join(awful.button({}, 1,
function ()
    awful.util.spawn_with_shell("mpc next;or ncmpcpp next;or ncmpc next;or pms next")
    mpdwidget.update()
end)))
stop_icon:buttons(awful.util.table.join(awful.button({}, 1,
function ()
    play_pause_icon:set_image(beautiful.play)
    awful.util.spawn_with_shell("mpc stop;or ncmpcpp stop;or ncmpc stop;or pms stop")
    mpdwidget.update()
end)))
play_pause_icon:buttons(awful.util.table.join(awful.button({}, 1,
function ()
    awful.util.spawn_with_shell("mpc toggle;or ncmpcpp toggle;or ncmpc toggle;or pms toggle")
    mpdwidget.update()
end)))
...
globalkeys = awful.util.table.join(
    ...
    -- chromeme web app list
    awful.key({ modkey }, "j", function () awful.util.spawn("google-chrome --show-app-list") end),
...
awful.rules.rules = {
    ...
    { rule = { role = "pop-up" },
          ...
          callback = function (c) c.ontop = not c.ontop end,
    },
